...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    public function activate(Composer $composer, IOInterface $io)
    {
        ...
        $file = $this->_vendorDir . '/zivvio/extensions.php';
        if (!is_file($file)) {
    ...
    {
        $packageName = 'zivvio/zivvio';
        if (!isset($this->_packageUpdates[$packageName])) {
            return;
        }

        $package = $this->_packageUpdates['zivvio/zivvio'];
    ...
    private function printUpgradeLink($io, $package)
    {
        ...
        $io->write("  https://github.com/zivvio/zivvio/blob/$maxVersion/framework/UPGRADE.md\n");
    }
